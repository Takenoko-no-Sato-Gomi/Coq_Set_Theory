...
(*順序数*)
Definition Ordered_Number(x:Set):=(forall y:Set,y ∈ x->y ⊂ x)
/\(forall y z w:Set,(y ∈ x/\z ∈ x/\w ∈ x/\y ∈ z/\z ∈ w)->y ∈ w)
/\(forall y z:Set,(y ∈ x/\z ∈ x)->(y ∈ z\/y=z\/z ∈ y))
/\(forall y:Set,y ∈ x->~y ∈ y)
/\(forall y:Set,((y ⊂ x/\~y=∅)->exists z:Set,(z ∈ y/\forall w:Set,(w ∈ y->~w ∈ z)))).
